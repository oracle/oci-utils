...
from ..impl import IP_CMD, SUDO_CMD, PARTED_CMD, MK_XFS_CMD, print_choices, VIRSH_CMD, LSBLK_CMD, IF_NAME_PREFIX
        ...
        if _is_bm_shape:
            ...
            for free_vnic_ip_addr in free_vnic_ip_addrs:
                ...
                args.append('type=direct,source={}{},source_mode=passthrough,mac={},'
                            'model=e1000'.format(IF_NAME_PREFIX, vnic['vlanTag'], vnic['macAddr']))
        else:
