...
class Qcow2Head(DeviceData):
    """
    Class to analyse header of qcow2 image file; ref
    https://github.com/01org/KVMGT-qemu/blob/master/tests/qemu-iotests/qcow2.py
    ...
    def show_header(self):
        ...
        -------
            No return value.
        """
        print '\n  %30s\n  %30s' % ('QCOW2 file header data', '-'*30)
        for f in Qcow2Head.header2_structure:
            print "  %-30s" % f[2], f[1] % self.qcowhead_dict[f[2]]
