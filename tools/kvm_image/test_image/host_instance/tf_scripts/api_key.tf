...
resource "null_resource" "oci_sdk_config" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
       ...
       "/bin/sudo chmod 700 /root/.oci",
       "/bin/sudo --preserve-env mkdir -p /home/${var.remote_user}/.oci",
       "/bin/sudo cp /tmp/config /home/${var.remote_user}/.oci/config",
       "/bin/sudo --preserve-env chown -R ${var.remote_user}:${var.remote_user} /home/${var.remote_user}/.oci",
       "/bin/sudo chmod -R 600 /home/${var.remote_user}/.oci/",
       "/bin/sudo chmod 700 /home/${var.remote_user}/.oci"
    ]
  }
}
